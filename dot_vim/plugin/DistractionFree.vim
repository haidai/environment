...
function! DistractionFreeWriting()
		...
		exec "set background=".g:fullscreen_background
...
function! ToggleDistractionFreeWriting()
  if g:distractionFreeFullscreen == 'on'
    ...
    let g:distractionFreeFullscreen = 'off'
		...
		exec "set background=".g:normal_background
		" added escape function to allow for multiword font names
		" (AmaruCoder)
...
if !exists('g:fullscreen_background')
    let g:fullscreen_background = "light"
endif
...
if !exists('g:normal_background')
  if has("gui_macvim")
    let g:normal_background = "light"
  else
    let g:normal_background = g:background
  end
endif
